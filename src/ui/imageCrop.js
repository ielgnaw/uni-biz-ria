    ...
    ImageCrop.prototype = {
        ...
        getFlashVars: function () {
            ...
            return [
                ...
                'header=' + (me.header ? encodeURIComponent(uniUtil.stringify(me.header)) : ''),
                'button=' + (me.button ? encodeURIComponent(uniUtil.stringify(me.button)) : ''),
                ...
                'src=' + encodeURIComponent(uniUtil.stringify(me.src)),
                'dest=' + encodeURIComponent(uniUtil.stringify(me.dest))
            ].join('&amp;');
        },

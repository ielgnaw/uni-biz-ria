...
define(function (require) {
    ...
    Image.prototype.initStructure = function () {
        ...
        this.helper.addDOMEvent(this.main, 'click', this.delImage);
    };

    Image.prototype.delImage = function (e) {
        var target = e.target || e.srcElement;
        if (target.className === this.helper.getPartClassName('del')) {
            this.restoreInitialState();
            this.delCallback && typeof this.delCallback === 'function' && this.delCallback();
        }
    };
    ...
    Image.prototype.repaint = helper.createRepaint(
        Control.prototype.repaint,
        {
            ...
            paint: function (image, url) {
                ...
                var close = image.helper.createPart('del');
                close.innerHTML = 'x';
                image.helper.getPart('content').appendChild(close);
